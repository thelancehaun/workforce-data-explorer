"""US state reference: name ↔ postal abbreviation ↔ census/BLS FIPS code."""
...
NAME_TO_ABBREV = {name: ab for name, ab, _ in STATES}
NAME_TO_FIPS = {name: fips for name, _, fips in STATES}
ABBREV_TO_FIPS = {ab: fips for _, ab, fips in STATES}
ABBREV_TO_NAME = {ab: name for name, ab, _ in STATES}
